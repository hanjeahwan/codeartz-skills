...
<p align="center">
  <strong>边界分析 &middot; 指令审查 &middot; 反馈沉淀</strong><br>
...
<p align="center">
  <img src="assets/readme-illustrations/03-agent-feedback-loop.png" alt="agent-feedback-loop 把用户反馈筛成长期规则">
  <br>
  <sub>3. agent-feedback-loop：用户反馈先查重、过滤隐私，再合并成长期规则。</sub>
</p>
...
npx skills add https://github.com/hanjeahwan/codeartz-skills --skill agent-feedback-loop
```
